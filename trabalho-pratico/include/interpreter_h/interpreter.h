...
/**
 * @brief Função de interpretação de dados em lote.
 *
 * @param tokens A matriz de ponteiros de caracteres contendo os tokens.
 * @param j O índice do token.
 * @param i O número da linha.
 * @param catalogo_s O conjunto de catálogos a ser utilizado durante a interpretação.
 * @param l O número máximo de tokens.
 */
void interpreter(char** tokens, int j, int i, Catalogs* catalogo_s,int l);
